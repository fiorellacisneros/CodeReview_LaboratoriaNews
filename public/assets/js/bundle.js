...
const Footer = () => {
    ...
    const pull_right = $('<div class="pull-right hidden-xs hidden-sm"><div class="center"><img src="assets/img/flecha3.png" alt="flecha"></div><a href="#">SUBIR</a></div>');
